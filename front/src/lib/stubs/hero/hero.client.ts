...
// tslint:disable
import { FightService } from "./hero";
import type { FightResponse } from "./hero";
import type { FightRequest } from "./hero";
...
/**
 * @generated from protobuf service hero.FightService
 */
export interface IFightServiceClient {
    /**
     * @generated from protobuf rpc: Fight(hero.FightRequest) returns (hero.FightResponse);
     */
    fight(input: FightRequest, options?: RpcOptions): UnaryCall<FightRequest, FightResponse>;
}
/**
 * @generated from protobuf service hero.FightService
 */
export class FightServiceClient implements IFightServiceClient, ServiceInfo {
    ...
    fight(input: FightRequest, options?: RpcOptions): UnaryCall<FightRequest, FightResponse> {
        const method = this.methods[0], opt = this._transport.mergeOptions(options);
        return stackIntercept<FightRequest, FightResponse>("unary", this._transport, method, opt, input);
    }
}
