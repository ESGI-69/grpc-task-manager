...
/**
 * @generated from protobuf message hero.FightRequest
 */
export interface FightRequest {
    /**
     * @generated from protobuf field: int32 firstHeroId = 1;
     */
    firstHeroId: number;
    /**
     * @generated from protobuf field: int32 secondHeroId = 2;
     */
    secondHeroId: number;
}
/**
 * @generated from protobuf message hero.FightResponse
 */
export interface FightResponse {
    /**
     * @generated from protobuf field: int32 winnerId = 1;
     */
    winnerId: number;
    /**
     * @generated from protobuf field: int32 winnerHd = 2;
     */
    winnerHd: number;
    /**
     * @generated from protobuf field: int32 loserId = 3;
     */
    loserId: number;
    /**
     * @generated from protobuf field: int32 loserHp = 4;
     */
    loserHp: number;
}
...
class CreateRequest$Type extends MessageType<CreateRequest> {
    ...
    create(value?: PartialMessage<CreateRequest>): CreateRequest {
        const message = { power: 0, name: "", hp: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class UpdateRequest$Type extends MessageType<UpdateRequest> {
    ...
    create(value?: PartialMessage<UpdateRequest>): UpdateRequest {
        const message = { id: 0, power: 0, name: "", hp: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
// @generated message type with reflection information, may provide speed optimized methods
class FightRequest$Type extends MessageType<FightRequest> {
    constructor() {
        super("hero.FightRequest", [
            { no: 1, name: "firstHeroId", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "secondHeroId", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<FightRequest>): FightRequest {
        const message = { firstHeroId: 0, secondHeroId: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<FightRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FightRequest): FightRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* int32 firstHeroId */ 1:
                    message.firstHeroId = reader.int32();
                    break;
                case /* int32 secondHeroId */ 2:
                    message.secondHeroId = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: FightRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 firstHeroId = 1; */
        if (message.firstHeroId !== 0)
            writer.tag(1, WireType.Varint).int32(message.firstHeroId);
        /* int32 secondHeroId = 2; */
        if (message.secondHeroId !== 0)
            writer.tag(2, WireType.Varint).int32(message.secondHeroId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message hero.FightRequest
 */
export const FightRequest = new FightRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FightResponse$Type extends MessageType<FightResponse> {
    constructor() {
        super("hero.FightResponse", [
            { no: 1, name: "winnerId", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "winnerHd", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "loserId", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "loserHp", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<FightResponse>): FightResponse {
        const message = { winnerId: 0, winnerHd: 0, loserId: 0, loserHp: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<FightResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FightResponse): FightResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* int32 winnerId */ 1:
                    message.winnerId = reader.int32();
                    break;
                case /* int32 winnerHd */ 2:
                    message.winnerHd = reader.int32();
                    break;
                case /* int32 loserId */ 3:
                    message.loserId = reader.int32();
                    break;
                case /* int32 loserHp */ 4:
                    message.loserHp = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: FightResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 winnerId = 1; */
        if (message.winnerId !== 0)
            writer.tag(1, WireType.Varint).int32(message.winnerId);
        /* int32 winnerHd = 2; */
        if (message.winnerHd !== 0)
            writer.tag(2, WireType.Varint).int32(message.winnerHd);
        /* int32 loserId = 3; */
        if (message.loserId !== 0)
            writer.tag(3, WireType.Varint).int32(message.loserId);
        /* int32 loserHp = 4; */
        if (message.loserHp !== 0)
            writer.tag(4, WireType.Varint).int32(message.loserHp);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message hero.FightResponse
 */
export const FightResponse = new FightResponse$Type();
/**
...
/**
 * @generated ServiceType for protobuf service hero.FightService
 */
export const FightService = new ServiceType("hero.FightService", [
    { name: "Fight", options: {}, I: FightRequest, O: FightResponse }
]);
